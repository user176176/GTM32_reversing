...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define  DEFAULT_Ki 7.67
  //#define  DEFAULT_Kd 56.04
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Mk3 bed
  #define DEFAULT_bedKp 34.88
  #define DEFAULT_bedKi 1.46
  #define DEFAULT_bedKd 557.38
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 160 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 150, 5000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -1, -5, -2.70 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 80    // Y point for Z homing when homing all axes (G28).
#endif
